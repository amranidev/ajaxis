...
class FriendController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        $Request = $k->generateRowBtn([
         ['href' => '#modal1', 'class' => 'modalRow delete modal-trigger btn-floating red', 'value' => '<i class="material-icons">delete</i>', 'data-id' => $friend->id, 'data-link' => null],
         ['href' => '#modal1', 'class' => 'modalRow edit modal-trigger btn-floating green', 'value' => '<i class = "material-icons">system_update_alt</i>', 'data-id' => $friend->id, 'data-link' => '/friends/edit/'],
         ['href' => '#modal1','class' => 'modalRow show modal-trigger btn-floating blue', 'value' => '<i class = "material-icons">add</i>', 'data-id' => $friend->id, 'data-link' => '/friends/show/']],$Row);
    ...
    public function update(Request $request, $id) {
        ...
        $Request = $k->generateRowBtn([
            ['href' => '#modal1', 'class' => 'modalRow delete modal-trigger btn-floating red', 'value' => '<i class="material-icons">delete</i>', 'data-id' => $friend->id, 'data-link' => null],
            ['href' => '#modal1', 'class' => 'edit modalRow modal-trigger btn-floating green', 'value' => '<i class = "material-icons">system_update_alt</i>', 'data-id' => $friend->id, 'data-link' => '/friends/edit/'],
            ['href' => '#modal1', 'class' => 'modalRow show modal-trigger btn-floating blue', 'value' => '<i class = "material-icons">add</i>', 'data-id' => $friend->id, 'data-link' => '/friends/show/']],$Row);
